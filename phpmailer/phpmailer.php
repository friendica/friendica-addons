...
function phpmailer_load_config(App $a, ConfigFileManager $configFileManager)
{
	$a->getConfigCache()->load($configFileManager->loadAddonConfig('phpmailer'), \Friendica\Core\Config\ValueObject\Cache::SOURCE_STATIC);
}
