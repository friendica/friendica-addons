...
// Session is set
elseif ((isset($_SESSION['jappix_user']) && !empty($_SESSION['jappix_user'])) && (isset($_SESSION['jappix_password']) && !empty($_SESSION['jappix_password']))) {
    // Form sent pointer
    $login_fired = true;
    ...
    ?>
		...
		<div id="manager-content">
            ...
            elseif ($id == 7) {
                ...
                elseif (newUpdates($check_updates)) {
