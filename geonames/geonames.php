...
function geonames_load_config(\Friendica\App $a, Config\Cache\ConfigCacheManager $configCacheManager)
{
	$a->getConfigCache()->load($configCacheManager->loadAddonConfig('geonames'));
}
