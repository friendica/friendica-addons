...
function impressum_load_config(App $a, ConfigFileManager $configFileManager)
{
	$a->getConfigCache()->load($configFileManager->loadAddonConfig('impressum'), \Friendica\Core\Config\ValueObject\Cache::SOURCE_STATIC);
}
