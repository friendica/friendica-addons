...
class tictac
{
	...
	*/
	...
	public function __construct($dimen, $handicap, $mefirst, $yours, $mine)
	{
		$this->dimen    = $dimen;
	...
	public function parse_moves($player)
	{
		$str = '';
	...
	public function defensive_move()
	{
	...
	public function offensive_move()
	{
	...
	public function marked_yours($x, $y, $z)
	{
	...
	public function marked_mine($x, $y, $z)
	{
		$str = sprintf("%d%d%d", $x, $y, $z);
	...
	public function uncontested_winner($w)
	{
	...
	public function is_neighbor($p1, $p2)
	{
		[$x1, $y1, $z1] = sscanf($p1, "%1d%1d%1d");
		[$x2, $y2, $z2] = sscanf($p2, "%1d%1d%1d");
	...
	public function uncontested_plane()
	{
		$freeplane = true;
		shuffle($this->planes);
		$pl = $this->planes;
