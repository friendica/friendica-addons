...
$a->strings['Help'] = '帮助';
$a->strings['Add and manage your personal content filter rules in this screen. Rules have a name and an arbitrary expression that will be matched against post data. For a complete reference of the available operations and variables, check the help page.'] = '在此添加和管理您的屏蔽关键词。有关过滤规则参考，请查看帮助页面。';
...
$a->strings['Cancel'] = '取消';
$a->strings['This addon requires this node having at least one post'] = '此插件要求本站至少有一个帖子。';
