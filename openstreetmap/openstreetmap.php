...
function openstreetmap_load_config(App $a, ConfigFileManager $configFileManager)
{
	$a->getConfigCache()->load($configFileManager->loadAddonConfig('openstreetmap'), \Friendica\Core\Config\ValueObject\Cache::SOURCE_STATIC);
}
