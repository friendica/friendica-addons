...
{
    public function testToClarkNotation()
    {
        $dom = new DOMDocument();
    ...
    public function testToClarkNotation2()
    {
        $dom = new DOMDocument();
    ...
    public function testToClarkNotationDAVNamespace()
    {
        $dom = new DOMDocument();
    ...
    public function testToClarkNotationNoElem()
    {
        $dom = new DOMDocument();
        $dom->loadXML('<?xml version="1.0"?><s:test1 xmlns:s="DAV:">Testdoc</s:test1>');
     ...
     */
    public function testLoadDOMDocumentEmpty()
    {
     ...
     * @expectedException Sabre_DAV_Exception_BadRequest
     */
    public function testLoadDOMDocumentInvalid()
    {
     ...
     * @depends testLoadDOMDocument
     */
    public function testLoadDOMDocumentUTF16()
    {
...
<root xmlns="DAV:">
  <prop>
     ...
     */
    public function testParsePropertiesEmpty()
    {
        $xml = '<?xml version="1.0"?>
<root xmlns="DAV:" xmlns:s="http://www.rooftopsolutions.nl/example">
  ...
  <prop>
     ...
     * @depends testParseProperties
     */
    public function testParsePropertiesComplex()
    {
        $xml = '<?xml version="1.0"?>
<root xmlns="DAV:">
  <prop>
  ...
  <prop>
     ...
     * @depends testParseProperties
     */
    public function testParsePropertiesNoProperties()
    {
        $xml = '<?xml version="1.0"?>
<root xmlns="DAV:">
  <prop>
    ...
    public function testParsePropertiesMapHref()
    {
        $xml = '<?xml version="1.0"?>
<root xmlns="DAV:">
  <prop>
