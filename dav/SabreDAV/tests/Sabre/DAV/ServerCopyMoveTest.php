...
class Sabre_DAV_ServerCopyMoveTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCopyToSelf()
    {
        $serverVars = array(
            'REQUEST_URI' => '/test.txt',
            'REQUEST_METHOD' => 'COPY',
    ...
    public function testBlockedOverWrite()
    {
        $serverVars = array(
            'REQUEST_URI' => '/test.txt',
            'REQUEST_METHOD' => 'COPY',
    ...
    public function testNonExistantParent()
    {
        $serverVars = array(
            'REQUEST_URI' => '/test.txt',
            'REQUEST_METHOD' => 'COPY',
    ...
    public function testRandomOverwriteHeader()
    {
        $serverVars = array(
            'REQUEST_URI' => '/test.txt',
            'REQUEST_METHOD' => 'COPY',
    ...
    public function testSimpleCopyFile()
    {
        $serverVars = array(
            'REQUEST_URI' => '/test.txt',
            'REQUEST_METHOD' => 'COPY',
    ...
    public function testSimpleCopyCollection()
    {
        $serverVars = array(
            'REQUEST_URI' => '/col',
            'REQUEST_METHOD' => 'COPY',
