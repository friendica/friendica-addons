...
class Sabre_CardDAV_PluginTest extends Sabre_CardDAV_AbstractPluginTest
{
    ...
    public function testMeCardTest()
    {
        ...
        $this->assertEquals(
            array(
                '{http://calendarserver.org/ns/}me-card' => new Sabre_DAV_Property_Href('addressbooks/user1/book1/vcard1.vcf'),
            ),
            $result
        );
    }
    ...
    public function testUpdatePropertiesMeCard()
    {
