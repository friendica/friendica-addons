...
class Sabre_CalDAV_OutboxPostTest extends Sabre_DAVServerTest
{
    ...
    public function testNoOriginator()
    {
        $req = new Sabre_HTTP_Request(array(
            'REQUEST_METHOD' => 'POST',
    ...
    public function testBadOriginator()
    {
        $req = new Sabre_HTTP_Request(array(
            'REQUEST_METHOD' => 'POST',
            'REQUEST_URI' => '/calendars/admin/outbox',
    ...
    public function testIncorrectOriginator()
    {
        $req = new Sabre_HTTP_Request(array(
            'REQUEST_METHOD' => 'POST',
            'REQUEST_URI' => '/calendars/admin/outbox',
    ...
    public function testNoIMIPHandler()
    {
        $req = new Sabre_HTTP_Request(array(
            'REQUEST_METHOD' => 'POST',
            'REQUEST_URI' => '/calendars/user1/outbox',
    ...
    public function testSuccessRequestUpperCased()
    {
        $req = new Sabre_HTTP_Request(array(
            'REQUEST_METHOD' => 'POST',
            'REQUEST_URI' => '/calendars/user1/outbox',
    ...
    public function testSuccessReply()
    {
        $req = new Sabre_HTTP_Request(array(
            'REQUEST_METHOD' => 'POST',
            'REQUEST_URI' => '/calendars/user1/outbox',
