...
abstract class Sabre_CalDAV_Backend_Common extends Sabre_CalDAV_Backend_Abstract
{
     ...
     * @var array
     */
    private static $calendarCache = array();

    /**
     * @var array
     */
    private static $calendarObjectCache = array();
     ...
     * @return array
     */
    public static function loadCalendarById($calendarId)
    {
     ...
     * @return array
     */
    public static function loadCalendarobjectById($obj_id)
    {
    ...
    public function updateCalendar($calendarId, array $mutations)
    {
        ...
        foreach ($newValues as $fieldName => $value) {
            $valuesSql[] = '`'.$fieldName."` = '".dbesc($value)."'";
        }
     ...
     * @return string
     */
    abstract public function getItemDetailRedirect($calendar_id, $calendarobject_id);
}
