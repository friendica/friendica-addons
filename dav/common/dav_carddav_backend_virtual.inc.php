...
abstract class Sabre_CardDAV_Backend_Virtual extends Sabre_CardDAV_Backend_Common
{
    ...
    */
     ...
     * @param int $addressbookId
     */
    public static function invalidateCache($addressbookId)
    {
     ...
     * @param bool $force
     */
    abstract protected static function createCache_internal($addressbookId, $force = false);
     ...
     * @param bool $force
     */
    abstract protected static function createCardCache($addressbookId, $contactId, $force = false);
    ...
    public function getCards($addressbookId)
    {
        ...
        foreach ($x as $y) {
            $ret[] = self::getCard($addressbookId, $add[0]['uri'], $add[0], $y);
        }
     ...
     * @param array                   $parameters
     */
    public static function card_del_automatic_value(&$component, $prop_name, $parameters = array())
    {
        // @TODO
    }
    ...
    public function getCard($addressbookId, $objectUri, $book = null, $obj = null)
    {
        ...
        if ($obj == null) {
            ...
            $obj = $r[0];
            if ($obj['needs_rebuild'] == 1) {
                $obj = static::createCardCache($addressbookId, $obj['contact']);
            }
        }
     ...
     */
    public function createCard($addressbookId, $objectUri, $cardData)
    {
        throw new Sabre_DAV_Exception_Forbidden();
    }
