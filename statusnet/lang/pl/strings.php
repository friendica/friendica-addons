...
$a->strings["GNU Social settings updated."] = "Ustawienia społeczności GNU zaktualizowane.";
...
$a->strings["Copy the security code from GNU Social here"] = "Skopiuj kod bezpieczeństwa z GNU Social tutaj";
...
$a->strings["If enabled all your <strong>public</strong> postings can be posted to the associated GNU Social account. You can choose to do so by default (here) or for every posting separately in the posting options when writing the entry."] = "Jeśli ta opcja jest włączona, wszystkie twoje <strong>publiczne</strong> ogłoszenia mogą zostać wysłane na powiązane konto społecznościowe GNU. Możesz to zrobić domyślnie (tutaj) lub dla każdego księgowania osobno w opcjach księgowania podczas pisania wpisu.";
$a->strings["<strong>Note</strong>: Due your privacy settings (<em>Hide your profile details from unknown viewers?</em>) the link potentially included in public postings relayed to GNU Social will lead the visitor to a blank page informing the visitor that the access to your profile has been restricted."] = "<strong>Uwaga</strong>: Ze względu na twoje ustawienia prywatności (<em>Ukryć dane swojego profilu od nieznanych widzów?</em>) Link potencjalnie zawarty w publicznych ogłoszeniach przekazywanych do GNU Social poprowadzi użytkownika do pustej strony informującej gościa, że ​​dostęp do twojego profilu został ograniczony.";
