...
$a->strings['<strong>Note</strong>: Due your privacy settings (<em>Hide your profile details from unknown viewers?</em>) the link potentially included in public postings relayed to GNU Social will lead the visitor to a blank page informing the visitor that the access to your profile has been restricted.'] = '<strong>Uwaga</strong>: Ze względu na Twoje ustawienia prywatności (<em>Ukryć szczegóły Twojego profilu przed anonimowymi przeglądającymi?</em>) link potencjalnie zawarty w publicznych wpisach przekazywanych do GNU Social doprowadzi odwiedzającego do pustej strony, informującej, że dostęp do Twojego profilu został ograniczony.';
