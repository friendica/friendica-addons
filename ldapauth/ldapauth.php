...
function ldapauth_load_config(App $a, ConfigFileManager $configFileManager)
{
	$a->getConfigCache()->load($configFileManager->loadAddonConfig('ldapauth'), \Friendica\Core\Config\ValueObject\Cache::SOURCE_STATIC);
}
